...
+
SnapCenter Plug-in for VMware vSphereとSnapCenter の間の通信チャネルで次の脆弱な暗号が無効になり、に示す追加の脆弱な暗号が使用されなくなります `include.weakCiphers`：TLS_RSA_WITH_AES_256_CBC_SHA256 TLS_DHE_256_CBC_SHA256 TLS_RSA_WITH_AES_128_CBC_TLS_RSA_WITH_AES_128_CBC_TLS_RSA_WITH_AES_128_CBC_256_ECDHE_RSA_SHA256_AES_SHA256_SHA256_AES_RSA_256_AES_256を使用したRSA_256_RSA_256_RSA_256_256 _AES_AES_CBC_256 _RSA_256_RSA_256_256 _256を使用したRSA_256_RSA_256_RSA_256_RSA_256_RSA_256_AES_RSA_
